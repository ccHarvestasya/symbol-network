Symbol Bootstrap Version: 1.1.0
...
.. csv-table::
    ...
    **harvesting**; ; ;
    ...
    beneficiaryAddress; NCHBDENCLKEBILBPWP3JPB2XNY64OE7PYHHE6FI; Address; Address of the account receiving part of the harvested fee.
...
.. csv-table::
    ...
    **network**; ; ;
    ...
    nemesisSignerPublicKey; 43AAE8EBBDEDB969415D020B0121118022722A577758C5FA88DCD9D8A2116533; Key; Nemesis public key.
    ...
    epochAdjustment; 1626575785s; utils::TimeSpan; Nemesis epoch time adjustment.
    **chain**; ; ;
    ...
    currencyMosaicId; 0x5BF0'8CAE'3059'9605; MosaicId; Mosaic id used as primary chain currency.
    harvestingMosaicId; 0x5BF0'8CAE'3059'9605; MosaicId; Mosaic id used to provide harvesting ability.
    ...
    harvestNetworkFeeSinkAddress; NA3NCRJUWSHVHS7XZRMMEB5XPOR26KP4Q7NVESY; Address; Address of the harvest network fee sink account.
    ...
    **plugin:catapult.plugins.mosaic**; ; ;
    ...
    mosaicRentalFeeSinkAddress; NADBIV3AK4CS3323V43HA5XM4PSI53ZYK7I6BTA; Address; Address of the mosaic rental fee sink account.
    ...
    **plugin:catapult.plugins.namespace**; ; ;
    ...
    namespaceRentalFeeSinkAddress; NCMIS5TGLZD3FHXPW47ATU2SITSLS2IIMKVGDWY; Address; Address of the namespace rental fee sink account.
...
.. csv-table::
    ...
    **localnode**; ; ;
    ...
    friendlyName; nemesis-private-node; string; Node friendly name (leave empty to use address).
